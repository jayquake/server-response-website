...
export const InternalErrorResponse = () => <FetchStatusComponent path="" />;
...
export const BlockedbyCloudflare = () => <FetchStatusComponent path="" />;
...
export const PageScanInterrupted = () => <FetchStatusComponent path="" />;
